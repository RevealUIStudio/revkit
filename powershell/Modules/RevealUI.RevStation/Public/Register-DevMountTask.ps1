...
function Register-DevMountTask {
    <#
    .SYNOPSIS
        Registers a Task Scheduler task to auto-mount the Forge drive to WSL.
    .DESCRIPTION
...
<Task version="1.4" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  <RegistrationInfo>
    <Description>Auto-mount WD My Passport SSD to WSL at /mnt/forge via RevealUI.RevStation module</Description>
  </RegistrationInfo>
  <Triggers>
    <LogonTrigger>
