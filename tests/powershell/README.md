...
| `WslHostScripts.Tests.ps1` | Register-WeeklyBackupTask / Move-WslVhdx / Apply-WslHostFix / Register-VHDxCompactTask | Source contracts: conhost `--headless`, WakeToRun, `wsl --manage --move` to `E:\WSL`, no export/import. Task Scheduler writes stay integration-only. |
